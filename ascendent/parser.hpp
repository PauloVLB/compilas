  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_TRUE = 7,                              // TRUE
        S_FALSE = 8,                             // FALSE
        S_NULL_LIT = 9,                          // NULL_LIT
        S_PROGRAM = 10,                          // PROGRAM
        S_BEGIN_TOK = 11,                        // BEGIN_TOK
        S_END = 12,                              // END
        S_VAR = 13,                              // VAR
        S_PROCEDURE = 14,                        // PROCEDURE
        S_STRUCT = 15,                           // STRUCT
        S_IN = 16,                               // IN
        S_IF = 17,                               // IF
        S_THEN = 18,                             // THEN
        ...
        S_DIV = 43,                              // DIV
        S_EXP_OP = 44,                           // EXP_OP
        S_FLOAT_T = 45,                          // FLOAT_T
        S_INT_T = 46,                            // INT_T
        S_STRING_T = 47,                         // STRING_T
        S_BOOL_T = 48,                           // BOOL_T
        S_49_ = 49,                              // ';'
        S_50_ = 50,                              // ':'
        S_51_ = 51,                              // '('
        ...
        S_opt_decls = 61,                        // opt_decls
        S_decl_tail = 62,                        // decl_tail
        S_decl = 63,                             // decl
        S_var_decl = 64,                         // var_decl
        S_var_init_opt = 65,                     // var_init_opt
        S_proc_decl = 66,                        // proc_decl
        S_opt_param_list = 67,                   // opt_param_list
        S_paramfield_tail = 68,                  // paramfield_tail
        S_opt_type = 69,                         // opt_type
        S_block = 70,                            // block
        S_proc_body_opt = 71,                    // proc_body_opt
        S_rec_decl = 72,                         // rec_decl
        S_opt_paramfield_decls = 73,             // opt_paramfield_decls
        S_paramfield_decl_tail = 74,             // paramfield_decl_tail
        S_paramfield_decl = 75,                  // paramfield_decl
        S_stmt_list = 76,                        // stmt_list
        S_stmt_tail = 77,                        // stmt_tail
        S_stmt = 78,                             // stmt
        S_assign_stmt = 79,                      // assign_stmt
        S_if_stmt = 80,                          // if_stmt
        S_else_opt = 81,                         // else_opt
        S_while_stmt = 82,                       // while_stmt
        S_return_stmt = 83,                      // return_stmt
        S_return_exp_opt = 84,                   // return_exp_opt
        S_call_stmt = 85,                        // call_stmt
        S_call_args_opt = 86,                    // call_args_opt
        S_call_args_tail = 87,                   // call_args_tail
        S_expression = 88,                       // expression
        S_or_exp = 89,                           // or_exp
        S_and_exp = 90,                          // and_exp
        S_not_exp = 91,                          // not_exp
        S_rel_exp = 92,                          // rel_exp
        S_add_exp = 93,                          // add_exp
        S_mult_exp = 94,                         // mult_exp
        S_exp_exp = 95,                          // exp_exp
        S_unary_exp = 96,                        // unary_exp
        S_primary_exp = 97,                      // primary_exp
        S_var = 98,                              // var
        S_var_suffix = 99,                       // var_suffix
        S_ref_var = 100,                         // ref_var
        S_deref_var = 101,                       // deref_var
        S_literal = 102,                         // literal
        S_bool_literal = 103,                    // bool_literal
        S_type = 104                             // type
      };
    };
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_rec_decl: // rec_decl
        value.move< BoolAttr > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, BoolAttr&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const BoolAttr& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, TypedAttr&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const TypedAttr& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
    {
      ...
      case symbol_kind::S_proc_decl: // proc_decl
      case symbol_kind::S_rec_decl: // rec_decl
        value.template destroy< BoolAttr > ();
        break;
    ...
    // Implementation of make_symbol for each token kind.
      ...
      make_FLOAT_LITERAL ()
      {
        return symbol_type (token::FLOAT_LITERAL);
      }
#else
      static
      symbol_type
      ...
      make_NULL_LIT ()
      {
        return symbol_type (token::NULL_LIT);
      }
#else
      static
      symbol_type
      ...
      make_BEGIN_TOK ()
      {
        return symbol_type (token::BEGIN_TOK);
      }
#else
      static
      symbol_type
      ...
      make_EXP_OP ()
      {
        return symbol_type (token::EXP_OP);
      }
#else
      static
      symbol_type
      ...
      make_FLOAT_T ()
      {
        return symbol_type (token::FLOAT_T);
      }
#else
      static
      symbol_type
      ...
      make_INT_T ()
      {
        return symbol_type (token::INT_T);
      }
#else
      static
      symbol_type
      ...
      make_STRING_T ()
      {
        return symbol_type (token::STRING_T);
      }
#else
      static
      symbol_type
      ...
      make_BOOL_T ()
      {
        return symbol_type (token::BOOL_T);
      }
#else
      static
      symbol_type
    ...
    , value ()
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_proc_decl: // proc_decl
      case symbol_kind::S_rec_decl: // rec_decl
        value.copy< BoolAttr > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_proc_decl: // proc_decl
      case symbol_kind::S_rec_decl: // rec_decl
        value.move< BoolAttr > (YY_MOVE (s.value));
        break;
